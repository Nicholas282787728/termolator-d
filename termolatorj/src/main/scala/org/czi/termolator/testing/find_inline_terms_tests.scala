...
object find_inline_terms_tests extends App {
  ...
  test_find_inline_terms_for()

  def test_get_topic_terms() = {

    term_utilities.get_lines_from_file(new File(fileName_19729111 + ".txt"))
  ...
  def test_find_inline_terms_for() = {
    ...
    /**
      ...
      */
    find_terms.find_inline_terms_for(fileName_19729111, start = true)
  }
}
